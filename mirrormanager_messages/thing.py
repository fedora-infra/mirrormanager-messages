...
from .base import SCHEMA_URL, MirrorManagerMessage, THING_SCHEMA


class NewThingV1(MirrorManagerMessage):
    """
    A sub-class of a Fedora message that defines a message schema for messages
    published by MirrorManager when a new thing is created.
    """

    topic = "mirrormanager.new"
